...
const syncAndSeed = async() => {
    ...
    await Promise.all([
       ...
       Drink.create({ name: 'Strawberry Matcha Latte w/ Boba', category: 'Bear Matcha', imageUrl: 'https://i.imgur.com/RPTE5cV.png' }),
       Drink.create({ name: 'Yuzu Matcha Latte w/ Boba', category: 'Bear Matcha', imageUrl: 'https://i.imgur.com/gg2Fy5U.png' }),
